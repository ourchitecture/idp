...
- [tests/contract/README.md](https://github.com/ourchitecture/idp/blob/main/tests/contract/README.md) — Quick reference for env vars and run commands
- [src/stacks/README.md](https://github.com/ourchitecture/idp/blob/main/src/stacks/README.md) — Stack layout conventions and portfolio roles
