...
#   RESULT_FLOW_INSIGHTS_EQUIVALENCE — check-flow-insights-equivalence job result
#
# Exit codes:
...
: "${RESULT_FLOW_INSIGHTS_EQUIVALENCE:?RESULT_FLOW_INSIGHTS_EQUIVALENCE is required}"
...
_check "check-flow-insights-equivalence" "${RESULT_FLOW_INSIGHTS_EQUIVALENCE}"
